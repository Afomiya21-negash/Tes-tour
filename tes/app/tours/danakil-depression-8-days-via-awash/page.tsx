...
export default function EightDaysDanakilViaAwashPage() {
  ...
  const galleryImages = [
    "/images/danki1.jpg?height=400&width=800",
    "/images/danki2.jpg?height=400&width=800",
    "/images/danki3.jpg?height=400&width=800",
      ...
      <section className="relative h-100 overflow-hidden">
        <div className="relative w-full h-full">
          <Image
            ...
            alt="8 Days Danakil Via Awash Gallery"
            width={1200}
            height={400}
