...
export default function SouthernTourPage() {
  ...
  const tours = [
    {
      id: "11-days",
      title: "11 Days Omo valley",
      image: "/images/11days omo.jpg",
      duration: "7 Days",
      route: "/tours/south-omo/11-days",
      nextDepartures: [
        "August 31, 2025",
        "September 1, 2025", 
        "September 2, 2025"
    ...
    {
      id: "8-days", 
      title: "8 days Omo Valley : Dorze and Arba Minch",
      image: "/images/7days omo4.jpg",
      duration: "9 Days",
      route: "/tours/south-omo/8-days",
      nextDepartures: [
        "August 31, 2025",
        "September 1, 2025",
        "September 2, 2025"
    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Southen Tour</h1>
