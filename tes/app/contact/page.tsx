      ...
      <section className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white section-padding">
        <div className="container-max text-center">
          ...
          <p className="text-xl text-emerald-100 max-w-2xl mx-auto">
            Have questions about your next adventure? We're here to help you plan the perfect trip. Get in touch with
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Our experienced travel consultants are ready to help you create unforgettable memories. Reach out to
        ...
        <div className="container-max">
          ...
          <div className="bg-gray-200 rounded-lg h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">123 Adventure Street, Travel District, TD 12345</p>
            </div>
          </div>
        </div>
      </section>
